...
CREATE TABLE `t_user` (
  ...
  KEY `t_user_t_province_p_id_fk` (`p_id`),
  KEY `t_user_t_city_c_id_fk` (`c_id`),
  CONSTRAINT `t_user_t_city_c_id_fk` FOREIGN KEY (`c_id`) REFERENCES `t_city` (`c_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `t_user_t_province_p_id_fk` FOREIGN KEY (`p_id`) REFERENCES `t_province` (`p_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('admin', '202cb962ac59075b964b07152d234b70', '管理员', 'admin@qq.com', '1', '1');
INSERT INTO `t_user` VALUES ('Lb2020', 'e10adc3949ba59abbe56e057f20f883e', '李白', 'lb2020@qq.com', '1', '1');
INSERT INTO `t_user` VALUES ('ssx2020', '81dc9bdb52d04dc20036dbd8313ed055', '孙尚香', 'ssx123@qq.com', '2', '7');
INSERT INTO `t_user` VALUES ('zj2020', '827ccb0eea8a706c4c34a16891f84e7b', '甄姬', '12333@qq.com', '5', '26');
INSERT INTO `t_user` VALUES ('zzc01', '827ccb0eea8a706c4c34a16891f84e7b', '超级英雄', 'zzc0101@qq.com', '5', '30');
...
INSERT INTO `t_user_role` VALUES ('22', '2', 'Lb2020');
INSERT INTO `t_user_role` VALUES ('29', '2', 'ssx2020');
